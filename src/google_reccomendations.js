...
exports.getTop50PopularPlaces = getTop50PopularPlaces;
var axios_1 = require("axios");
var dotenv = require("dotenv");
var path_1 = require("path");
var get_city_pics_1 = require("./get_city_pics");
...
function getTop50PopularPlaces(lat, lng, cityName) {
    return __awaiter(this, void 0, void 0, function () {
        var url, places, nextPageToken, requestUrl, response, top50Places, popularPlaces, i, place, detailsUrl, detailsResponse, placeDetails, description, image, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 4:
                    _a.sent(); // Delay for 2 seconds to wait for the next page token to become active
                    _a.label = 5;
                case 5:
                ...
                case 6:
                    ...
                    _a.label = 7;
                case 7:
                    if (!(i < top50Places.length)) return [3 /*break*/, 11];
                    place = top50Places[i];
                ...
                case 8:
                    ...
                    return [4 /*yield*/, (0, get_city_pics_1.fetchCityPictureUrl)(place.name)];
                case 9:
                    image = _a.sent();
                ...
                case 10:
                    i++;
                    return [3 /*break*/, 7];
                case 11: return [2 /*return*/, popularPlaces];
                case 12:
                    error_1 = _a.sent();
